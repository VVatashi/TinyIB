...
true, true];
	...
	function getImageBoard(checkDomains, checkEngines) {
		...
		var TempLewdGa = function (_TinyIB) {
			_inherits(TempLewdGa, _TinyIB);

			function TempLewdGa(prot, dm) {
				_classCallCheck(this, TempLewdGa);
		...
		ibDomains['temp.lewd.ga'] = TempLewdGa;
		ibDomains['temp.lewd.test'] = TempLewdGa;
		ibDomains['tinyib.test'] = TempLewdGa;
